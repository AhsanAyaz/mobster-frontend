...
`;l(document.querySelector("#counter"));const a=async()=>{const o=await(await fetch("https://mobster-backend-production.up.railway.app/pets")).json();console.log({pets:o.data.pets})};a();
